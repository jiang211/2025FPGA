...
reg [11:0] Adc_Data_CHA/*synthesis noprune*/;		// 通道A采集数据
reg [11:0] Adc_Data_CHB/*synthesis noprune*/;		// 通道B采集数据
...
begin
	Adc_Data_CHA <= Adc_In_A^12'hFFF; /* 输入到AD9226的信号是反相的所以需要取反一下 */
end

// 功能：读取通道B的采集数据
always @(posedge Adc_ReadClk_65M)
begin
	Adc_Data_CHB <= Adc_In_B^12'hFFF; /* 输入到AD9226的信号是反相的所以需要取反一下 */
end
